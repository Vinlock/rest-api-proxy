module.exports = function (api) {
  ...
  config.env.production.presets.push('@babel/preset-flow');
  ...
  config.env.test.presets.push('@babel/preset-flow');

  /** Test Env Plugins */
  config.env.test.plugins.push('transform-flow-strip-types');
